 ...
 * <br /><br />
 * Elle contient le minimum commun à toutes les formes qu'il sera possible d'afficher : 
 * la couleur.<br />. De plus, elle contient les méthodes abstaites qui devront être redéfinies 
 * par ses sous-classes. Chaque forme devra être capable de s'afficher et de se translater. 
 * 
 * Afin de gérer les collisions, chaque forme devra également être capable de retourner sa boite englobante. 
 * Deux méthodes existent dans cette classe afin de gérer les collisions : intersection et intersectionRapide prenant toutes les deux une forme en paramètre. 
 * La première peut être redéfinie afin de gérer les collisions de manière précise alors que la seconde ne peut être redéfinie et sera utilisée pour faire 
 * des tests de collision rapidement.<br />
