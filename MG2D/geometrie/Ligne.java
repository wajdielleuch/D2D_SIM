...
public class Ligne extends Dessin {
     ...
     * Construit une Ligne à partir de deux Points.<br />
     * Il s'agit du constructeur sans couleur, ainsi l'objet sera noir.
     * @param id de la ligne.
     * @param a Premier point.
     * @param b Second point.
     * @see Point
     */
    public Ligne (int id, Point a, Point b,Couleur couleur) {
     ...
     * @see Point
     */
    public Ligne ( int id, Couleur couleur, Point a, Point b ) {
    ...
    /**
     * Retourne la longueyr de  la ligne.
     * @return longuer  .
     */
    public int getLongueur () {
    int a = this.getA().getX() - this.getB().getX();
    int b = this.getA().getY() - this.getB().getY();
	...
	this.b = new Point(b);
      ...
      /**
     * Permet d'attribuer un Nouveau id.
     * @param id.
     * @see Point
     */
    public void setid ( int id ) {
      ...
      /**
     * Permet d'attribuer une Couleur.
     * @param Couleur.
     * @see Point
     */
