...
public class MusiqueATester extends Thread {
     ...
     */
    public MusiqueATester(String fic) throws java.lang.RuntimeException{
	try{
		...
		player.setPlayBackListener(new PlaybackListener(){
			...
			public void playbackFinished(PlaybackEvent evt){
			    try{
				MusiqueATester m = new MusiqueATester(fichier);
				enCours=m;
				m.lecture();
				stop();
			    }
     ...
     */
   public MusiqueATester(InputStream is) throws java.lang.RuntimeException{
	try{
    if(nbConfig==0){
        enCours=this;
        nbConfig++;
		...
		player.setPlayBackListener(new PlaybackListener(){
			...
			public void playbackFinished(PlaybackEvent evt){
			    try{
				MusiqueATester m = new MusiqueATester(is);
				enCours=m;
				m.lecture();
				stop();
			    }
